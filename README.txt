Hello and Welcome to the Deck Factory 2! (NOW WITH RUDIMENTARY GUI)
...
a couple of notes.
1. Custom deck lists (not generated in Xmage) should be .txt files or .json files, Xmage generates .dck files.
...
Read formatTutorial.txt in the Decklists Folder for a tutorial on the custom format.
Also there is now a custom deck editor! just use it to make the most effective format more easily.

Collector Number based selection of cards does work now, and is explained in the formatTutorial.txt mentioned above.

You will have to find or create whatever image you would like to serve as the card back, whether that be custom or the standard card back. We cannot distribute the standard card back as it is property of WotC. It is easy enough to find though. I suggest an image that is at least 332x500, as that will be the resolution of the images on the fronts of the cards.
